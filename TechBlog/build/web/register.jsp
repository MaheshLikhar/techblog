...
<html>
    ...
    <body>
        ...
        <main class="primary-background p-5 banner-clippath">
                        ...
                        <div class="card-body">
                            ...
                            <form id="reg_form" action="RegisterServlet" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="user_name" type="text" class="form-control" id="exampleInputName"  placeholder="Enter user name">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="radio"  id="" name="gender" value="femail" > Female
                                </div>
...
//                            console.log("sucess");
                            ...
                            swal("Registration Sucessfull... we are Redirectingg to the login Page")
                                    .then((value) => {
